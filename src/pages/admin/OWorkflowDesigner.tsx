...
interface IDisplayBoardDefinition {
    ...
    kitchenCode?: string; // TV bound to this kitchen
}
                                        ...
                                        {workflow.serviceGroups.map(group => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`cursor-pointer p-3 rounded-lg border flex items-start gap-3 transition-all ${isSelected
                                                        ? 'bg-blue-50 border-blue-200 dark:bg-blue-900/20 dark:border-blue-800'
                                                        : 'bg-gray-50 border-transparent hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800'
                                                        }`}
                                                >
                                                    <div className={`w-5 h-5 rounded flex items-center justify-center border ${isSelected ? 'bg-blue-500 border-blue-500 text-white' : 'bg-white border-gray-300'
                                                        }`}>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="md:w-1/3 space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Kitchen Code</label>
                                            <input
                                                type="text"
                                                value={point.kitchenCode || ''}
                                                onChange={(e) => updateServicePoint(point.code, { kitchenCode: e.target.value })}
                                                className="w-full text-sm font-mono text-gray-600 dark:text-gray-300 bg-transparent border-b border-gray-200 focus:border-blue-500 outline-none pb-1"
                                            ...
                                            {workflow.serviceGroups.map(group => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`cursor-pointer p-2 rounded-lg border flex items-center gap-2 transition-all ${isSelected
                                                            ? 'bg-blue-50 border-blue-200 dark:bg-blue-900/20 dark:border-blue-800'
                                                            : 'bg-gray-50 border-transparent hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800'
                                                            }`}
                                                    >
                                                        <div className={`w-4 h-4 rounded flex items-center justify-center border ${isSelected ? 'bg-blue-500 border-blue-500 text-white' : 'bg-white border-gray-300'
                                                            }`}>
                            ...
                            >
                                <div className="p-5">
                                    <div className="flex justify-between items-start mb-3">
                                        <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider ${group.priority === 'Urgent' ? 'bg-red-100 text-red-700' :
                                ...
                                <div className="flex-1 overflow-y-auto p-2 space-y-2">
                                    {sortedStates.map((state, idx) => (
                                        <div
                                            ...
                                            className={`p-3 rounded-lg cursor-pointer border transition-all flex items-center gap-3 ${selectedStateCode === state.code
                                    ...
                                    <div className="max-h-60 overflow-y-auto">
                                        {profiles.map(profile => (
                                            <div
                                                ...
                                                className={`w-full text-left px-4 py-2 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-between cursor-pointer group ${selectedProfileId === profile.code ? 'text-blue-600 bg-blue-50 dark:bg-blue-900/20' : 'text-gray-700 dark:text-gray-300'
                                                    }`}
                                            >
